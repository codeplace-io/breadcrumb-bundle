...
use Thormeier\BreadcrumbBundle\DependencyInjection\BreadcrumbProviderAwareCompilerPass;
...
class ThormeierBreadcrumbBundle extends Bundle
{
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->addCompilerPass(new BreadcrumbProviderAwareCompilerPass());
    }
}
